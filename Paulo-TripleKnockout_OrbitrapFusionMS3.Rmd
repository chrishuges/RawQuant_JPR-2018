---
title: "Analysis of Orbitrap Fusion MS3 Data from Paulo *et al.*"
...
This file contains the code for processing the search and quantification output files from the triple knockout publication from Paulo *et al.* (PMID: 27400695). **These data were used to make portions of Figure S3 - S6.**
...
psm_files = list.files('/projects/ptx_results/OtherDataSets/2017-June_Paulo_TKO/reports-output',pattern='m.*ms3.*Default_PSM_Report.txt',full.names=TRUE)
#quant files from RawQuant algorithm
quant_files = list.files('/projects/ptx_results/OtherDataSets/2017-June_Paulo_TKO/quant-output',pattern='m.*ms3.*QuantData.txt',full.names=TRUE)
#quant files from Proteome Discoverer
pd_files = list.files('/projects/ptx_results/OtherDataSets/2017-June_Paulo_TKO/pd-quant-output',pattern='m.*ms3.*QuanSpectra.txt',full.names=TRUE)
...
saveRDS(psm_all, '/projects/ptx_analysis/chughes/projects-current/raw-quant/published-data/paulo_TKO/Routput/paulo-fusion-ms3_all-psms-id-quant.rds')
```

Now we can plot some of the data to see how well the observations align with previously published results.

```{r}
psm_set = readRDS('/projects/ptx_analysis/chughes/projects-current/raw-quant/published-data/paulo_TKO/Routput/paulo-fusion-ms3_all-psms-id-quant.rds') #read in the processed data
...
save_plot('/projects/ptx_analysis/chughes/projects-current/raw-quant/published-data/paulo_TKO/Routput/paulo_met6_fusionMS3-PD_boxplot.pdf',met6pd_plot) #save the plot
...
save_plot('/projects/ptx_analysis/chughes/projects-current/raw-quant/published-data/paulo_TKO/Routput/paulo_met6_fusionMS3-PY_boxplot.pdf',met6py_plot) #save the plot
...
save_plot('/projects/ptx_analysis/chughes/projects-current/raw-quant/published-data/paulo_TKO/Routput/paulo_pfk2_fusionMS3-PD_boxplot.pdf',pfk2pd_plot) #save the plot
...
save_plot('/projects/ptx_analysis/chughes/projects-current/raw-quant/published-data/paulo_TKO/Routput/paulo_pfk2_fusionMS3-PY_boxplot.pdf',pfk2py_plot) #save the plot
...
save_plot('/projects/ptx_analysis/chughes/projects-current/raw-quant/published-data/paulo_TKO/Routput/paulo_ura2_fusionMS3-PD_boxplot.pdf',ura2pd_plot) #save the plot
...
save_plot('/projects/ptx_analysis/chughes/projects-current/raw-quant/published-data/paulo_TKO/Routput/paulo_ura2_fusionMS3-PY_boxplot.pdf',ura2py_plot) #save the plot
